...
const Header = ({insideHome}) => {
  ...
  const userWsihlist = useSelector(state=>state.wishlistReducer)
  ...
  return (
    <nav className='flex bg-yellow-500 fixed w-full p-5'>
        ...
        <ul className='flex-1 text-right'>
            ...
            <li className='list-none inline-block px-5'><Link className='text-white font-bold' to={'/wishlist'}> <i className="fa-solid fa-heart text-red-600"></i> WishList <span className='rounded bg-black p-1'>{userWsihlist?.length}</span></Link></li>
