...
const Footer = () => {
  return (
    <div style={{ height: '300px' }} className='bg-yellow-500 container flex flex-col mt-10'>
      ...
      <p className='text-center text-white mt-3'>Copyright &copy; 2024 E Cart June24 Batch Student. Built with React.</p>
    </div>
  )
}
