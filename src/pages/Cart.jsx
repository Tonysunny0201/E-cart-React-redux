...
const Cart = () => {
  ...
  const handleDecrementQuantiy = (product)=>{
      ...
      <div style={{ paddingTop: "100px" }} className='container px-4 mx-auto'>
        {
          userCart?.length > 0 ?
                    ...
                    <tbody>
                      { userCart?.map((product,index) => (
                        <tr key={product?.id}>
                          ...
                          <td>
                            <div className='flex'>
                              <button onClick={()=>handleDecrementQuantiy(product)} className='font-bold'>-</button>
                              <input style={{ width: '40px' }} value={product?.quantity} type="text" name="" id="" readOnly className='border p-1 rounded ms-2 me-2' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img className='w-100 h-1/2' src="https://www.adanione.com/~/media/Foundation/Adani/emptyImages/empty_cart.gif" alt="EmptyCart" />
